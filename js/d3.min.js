...
(function(t, n) {
    ...
    function sn(t, n) {
        var e, r, i, o = rl.lastIndex = il.lastIndex = 0,
            ...
            f = [];
        for (t += "", n += "";
            (e = rl.exec(t)) && (r = il.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, f.push({
            i: a,
            x: fn(e, r)
        })), o = il.lastIndex;
    ...
    function gn(t, n) {
        var e, r, i = t[0],
            ...
            l = f - o,
            h = s * s + l * l;
        if (h < hl) r = Math.log(c / a) / cl, e = function(t) {
    ...
    function An() {
        mn(), ++bl;
        for (var t, n = Js; n;)(t = Al - n._time) >= 0 && n._call.call(null, t), n = n._next;
        --bl
    }
        ...
        function n(t, n) {
            function e() {
                ...
                if (t.charCodeAt(r) === qh) {
                    ...
                    return (n = u) >= a ? c = !0 : (e = t.charCodeAt(u++)) === Oh ? s = !0 : e === Yh && (s = !0, t.charCodeAt(u) === Oh && ++u), t.slice(r + 1, n - 1).replace(/""/g, '"')
                }
                for (; u < a;) {
    ...
    function Qi(t, n, e) {
        ...
        return t.scale(150).translate([0, 0]), null != r && t.clipExtent(null), yr(e, t.stream(jp)), n(jp.result()), null != r && t.clipExtent(r), t
    }
    ...
    function ca(t, n, e, r, i, o) {
        for (var a, u, f, c, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x;) {
            ...
            }), a.dice ? Ko(a, e, r, i, w ? r += c * s / w : o) : fa(a, e, r, w ? e += f * s / w : i, o), w -= s, b = m
        }
        return y
    }
        ...
        function e(t, n) {
            return function(e) {
                ...
                if ("p" in a && (a.H = a.H % 12 + 12 * a.p), "V" in a) {
                    ...
                    "w" in a || (a.w = 1), "Z" in a ? (i = (o = (i = Ha(Xa(a.y))).getUTCDay()) > 4 || 0 === o ? vg.ceil(i) : vg(i), i = hg.offset(i, 7 * (a.V - 1)), a.y = i.getUTCFullYear(), a.m = i.getUTCMonth(), a.d = i.getUTCDate() + (a.w + 6) % 7) : (i = (o = (i = n(Xa(a.y))).getDay()) > 4 || 0 === o ? Xv.ceil(i) : Xv(i), i = Iv.offset(i, 7 * (a.V - 1)), a.y = i.getFullYear(), a.m = i.getMonth(), a.d = i.getDate() + (a.w + 6) % 7)
    ...
    function Su(t, n) {
        var e = t.getDay();
        return t = e >= 4 || 0 === e ? $v(t) : $v.ceil(t), Va($v.count(ag(t), t) + (4 === ag(t).getDay()), n, 2)
    }
    ...
    function Hu(t, n) {
        var e = t.getUTCDay();
        return t = e >= 4 || 0 === e ? _g(t) : _g.ceil(t), Va(_g.count(Cg(t), t) + (4 === Cg(t).getUTCDay()), n, 2)
    }
                    ...
                    do {
                        ...
                        if (t === i.L) {
                            if ((n = i.R).C && (n.C = !1, i.C = !0, yc(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
                                n.R && n.R.C || (n.L.C = !1, n.C = !0, _c(this, n), n = i.R), n.C = i.C, i.C = n.R.C = !1, yc(this, i), t = this._;
                                break
                            }
                        } else if ((n = i.L).C && (n.C = !1, i.C = !0, _c(this, i), n = i.L), n.L && n.L.C || n.R && n.R.C) {
                            n.L && n.L.C || (n.R.C = !1, n.C = !0, yc(this, n), n = i.L), n.C = i.C, i.C = n.L.C = !1, _c(this, i), t = this._;
                            break
                        }
                        n.C = !0, t = i, i = i.U
                    } while (!t.C);
    ...
    Bc.prototype = Yc.prototype, t.version = "5.0.0", t.bisect = Zc, t.bisectRight = Zc, t.bisectLeft = Qc, t.ascending = n, t.bisector = e, t.cross = function(t, n, e) {
        ...
        if (yd = gd = -(pd = vd = 1 / 0), wd = [], yr(t, dp), e = wd.length) {
            for (wd.sort(qr), n = 1, o = [r = wd[0]]; n < e; ++n) Or(r, (i = wd[n])[0]) || Or(r, i[1]) ? (Ur(r[0], i[1]) > Ur(r[0], r[1]) && (r[1] = i[1]), Ur(i[0], r[1]) > Ur(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n) i = o[n], (u = Ur(r[1], i[0])) > a && (a = u, pd = i[0], gd = r[1])
        }
        ...
        function t() {
            ...
            return n = [], e = Jr(-t[0] * $d, -t[1] * $d, 0).invert, ri(a, u, f, 1), t = {
                type: "Polygon",
                coordinates: [n]
            }, n = e = null, t
        }
        ...
        function t(t) {
            ...
            if (o.parent = pv, o.eachBefore(function(t) {
                ...
                }).eachBefore(zo), o.parent = null, s > 0) throw new Error("cycle");
            return o
        }
        var n = ta,
            e = na;
        ...
        return n.transform = function(t, n) {
            ...
            e.property("__zoom", Xc), t !== e ? o(t, n) : e.interrupt().each(function() {
    ...
    }, t.zoomTransform = Bc, t.zoomIdentity = eb, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});